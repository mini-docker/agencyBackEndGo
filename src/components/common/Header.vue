		...
		<div class="header-right">
			<div class="header-user-con">
				...
				<div class="btn-fullscreen" @click="handleFullScreen">
					<el-tooltip
						effect="dark"
						:content="fullscreen ? $t('common.unfullScreen') : $t('common.fullScreen')"
						placement="bottom"
					>
				...
				<el-dropdown class="user-name" trigger="click" @command="handleCommand">
					...
					<el-dropdown-menu slot="dropdown">
						...
						<el-dropdown-item command="modifyPwd" v-show="this.token.isAdmin*1 !== 1">{{ $t('common.modify') + $t('common.pwd') }}</el-dropdown-item>
		...
		<el-dialog :title="ruleForm.formTitle" :visible.sync="editVisible" width="30%" @close="resetEdit('ruleForm')">
			<el-form :model="ruleForm" label-width="90px" :rules="rules" ref="ruleForm">
				...
				<el-form-item :label="$t('common.oldPwd')" prop="oldPwd">
					<el-input v-model="ruleForm.oldPwd" show-password auto-complete="new-password" :placeholder="$t('common.p_oldPwd')"></el-input>
				</el-form-item>
				<el-form-item :label="$t('common.loginPwd')" prop="loginPwd">
					<el-input v-model="ruleForm.loginPwd" show-password auto-complete="new-password" :placeholder="$t('common.p_loginPwd')"></el-input>
				</el-form-item>
				<el-form-item :label="$t('common.confirPwd')" prop="confirmPassword">
					<el-input v-model="ruleForm.confirmPassword" show-password auto-complete="new-password" :placeholder="$t('common.p_confirPwd')"></el-input>
				</el-form-item>
			</el-form>
...
export default {
	data() {
		...
		return {
            ...
            act: localStorage.getItem('ams_username'),
            token: JSON.parse(decodeURIComponent(sessionStorage.getItem('token'))),
		};
	},
	computed: {
		username() {
			let username = localStorage.getItem('ams_username');
